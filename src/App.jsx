    ...
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <section className="relative z-10 px-8 py-24 max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative flex justify-center">
          ...
          <div className="relative backdrop-blur-xl bg-white/5 border border-white/10 rounded-[2rem] p-6 shadow-2xl w-full max-w-md">
            <img
      ...
      <section className="relative z-10 px-8 py-16 max-w-7xl mx-auto">
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-[2rem] p-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              <p className="uppercase tracking-[0.2em] text-cyan-400 text-sm mb-2">
                Upload Projects
              </p>
      ...
      >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <div
              key={index}
              className="group backdrop-blur-xl bg-white/5 border border-white/10 rounded-[2rem] overflow-hidden hover:-translate-y-2 transition duration-300"
            >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h3 className="text-4xl font-black mb-6">
              I Create Trendy Digital Experiences
            </h3>
            <p className="text-white/70 leading-relaxed text-lg">
              ...
              built to be fully responsive and easy to deploy on GitHub Pages
              or Vercel.
            </p>
          </div>
      ...
      <section
        id="contact"
        className="relative z-10 px-8 pb-24 max-w-7xl mx-auto"
      >
        <div className="backdrop-blur-xl bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border border-white/10 rounded-[2rem] p-10 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="mailto:reymarttibe@gmail.com"
              className="px-6 py-3 rounded-2xl bg-white text-black font-semibold hover:scale-105 transition"
            >
              Email Me
            </a>
            ...
            <a
              href="https://www.linkedin.com/in/reymart-tibe-624b952b8/"
              target="_blank"
              className="px-6 py-3 rounded-2xl border border-white/20 hover:bg-white/10 transition"
            >
              Linkedin
